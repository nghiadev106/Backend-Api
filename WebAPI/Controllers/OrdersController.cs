...
namespace WebAPI.Controllers
{
    ...
    public class OrdersController : ApiControllerBase
    {
        ...
        public OrdersController(IOrderService orderService, IErrorService errorService) : base(errorService)
        {
        ...
        [HttpPost]
        [Route("add")]
        [Permission(Action = "Create", Function = "ORDER")]
        ...
        private string GenerateOrder(int orderId)
        {
            ...
            string documentName = string.Format("Order-{0}-{1}.xlsx", orderId, DateTime.Now.ToString("hhmmsssddMMyyy"));
            ...
            try
            {
                ...
                using (FileStream templateDocumentStream = File.OpenRead(templateDocument))
                {
                    ...
                    using (ExcelPackage package = new ExcelPackage(templateDocumentStream))
                    {
                        ...
                        ExcelWorksheet sheet = package.Workbook.Worksheets["NShopOrder"];
